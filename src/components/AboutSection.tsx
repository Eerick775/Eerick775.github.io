      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <p className="text-gold font-bold text-sm uppercase tracking-widest">Sobre</p>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {capabilities.map((cap) => (
              <div key={cap.text} className="bg-card border border-border rounded-xl p-6 space-y-3 hover:border-[hsl(var(--gold)/.4)] transition-colors">
